...
function test {
    ...
    export DISPLAY=:0
    ./com.github.arshubham.gitignore --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.arshubham.gitignore-pot
    ninja com.github.arshubham.gitignore-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.arshubham.gitignore "${@:2}"
    ;;
"test")
    test
    ;;
